...
## Now (진행 중, 1~3개)
- [ ] dev-meta-hierarchy Step 15.6 — verify.sh mh-fe-recommend 케이스 추가 + 통합 검증
- [ ] dev-meta-hierarchy Step 16 — mh-wrap (마무리 커밋·CLAUDE.md 갱신)
...
- [x] dev-meta-hierarchy Phase A — content_kind SSOT + read-time inheritance + gap-aware analyzer (Steps 0~5, 38 tests) (2026-05-19)
